...
public class OrderSummaryPerCustomer {
	...
	@Override
	public int hashCode() {
		return HashCodeBuilder.reflectionHashCode(this,new String[] {"productsOrdered", "productListCorrected"});
	}

	@Override
	public boolean equals(Object that) {
		return EqualsBuilder.reflectionEquals(this, that, new String[] {"productsOrdered", "productListCorrected"});
	}
